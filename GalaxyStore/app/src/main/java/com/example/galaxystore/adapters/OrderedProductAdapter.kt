...
import com.example.galaxystore.databinding.MyOrdersItemBinding
...
class OrderedProductAdapter(val onItemViewClicked: (OrderedProduct) -> Unit) : RecyclerView.Adapter<OrderedProductAdapter.OrderListViewHolder>() {
    ...
    inner class OrderListViewHolder(val binding: MyOrdersItemBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderListViewHolder {
        return OrderListViewHolder(MyOrdersItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
